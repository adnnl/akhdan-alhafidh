<template>
  <div
    class="nav-sidebar-links-wrapper"
    :class="{
    ...
    <ul class="nav-sidebar-links">
      <li
        ...
        :class="{
          'nav-sidebar-link-li-container-selected':
...
::-webkit-scrollbar-thumb {
  ...
  -webkit-box-shadow: rgba(155, 155, 155);
}
...
button.nav-sidebar-link-no-hover {
  i {
    color: $nav-contrast-60 !important;
  }
  ...
  button.nav-sidebar-link {
    ...
    span {
      ...
      &::before {
        ...
        border-width: 5px;
        border-style: solid;
        border-color: transparent darken($nav-highlight, 2%) transparent
          transparent;
      }
    }
  }
